...
const FEATURES = [
  ...
  },
  {
    ...
    files: [{ name: "app/router.ts", label: "TS" }, { name: "middleware.ts", label: "TS" }],
  },
  {
    ...
    files: [{ name: "pull_request.diff", label: "PR" }, { name: "review-comments.ts", label: "TS" }],
  },
  {
    ...
    files: [{ name: "health-score.ts", label: "TS" }, { name: "analytics.ts", label: "TS" }],
  },
  {
    ...
    files: [{ name: "dep-graph.ts", label: "TS" }, { name: "visualizer.tsx", label: "TSX" }],
  },
  {
    ...
    files: [{ name: "chat-handler.ts", label: "TS" }, { name: "context-builder.ts", label: "TS" }],
  },
  {
    ...
    files: [{ name: "auth.config.ts", label: "TS" }, { name: "session.ts", label: "TS" }],
  },
];
